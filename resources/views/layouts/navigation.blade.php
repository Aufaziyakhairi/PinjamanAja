<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->isPetugas())
                        <x-nav-link :href="route('petugas.approvals.index')" :active="request()->routeIs('petugas.approvals.*')">
                            {{ __('Approve') }}
                        </x-nav-link>
                        <x-nav-link :href="route('petugas.returns.index')" :active="request()->routeIs('petugas.returns.*')">
                            {{ __('Return') }}
                        </x-nav-link>
                    ...
                    @if(Auth::user()->isPeminjam())
                        <x-nav-link :href="route('peminjam.tools.index')" :active="request()->routeIs('peminjam.tools.*')">
                            {{ __('Daftar Alat') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->isPetugas())
                <x-responsive-nav-link :href="route('petugas.approvals.index')" :active="request()->routeIs('petugas.approvals.*')">
                    {{ __('Approve') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('petugas.returns.index')" :active="request()->routeIs('petugas.returns.*')">
                    {{ __('Return') }}
                </x-responsive-nav-link>
            ...
            @if(Auth::user()->isPeminjam())
                <x-responsive-nav-link :href="route('peminjam.tools.index')" :active="request()->routeIs('peminjam.tools.*')">
                    {{ __('Daftar Alat') }}
                </x-responsive-nav-link>
