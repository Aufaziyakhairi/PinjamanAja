<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.reports.print', request()->query()) }}" target="_blank" class="ss-link text-sm">Cetak</a>
        </div>
    </x-slot>
    ...
    <div class="ss-container">
        ...
        <div class="ss-card p-4 mb-4">
            <form class="grid grid-cols-1 sm:grid-cols-4 gap-3" method="GET">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('admin.reports.index') }}" class="ss-link text-sm">Reset</a>
                </div>
            </form>
        </div>
        ...
        <div class="mt-3 text-xs text-slate-500">
            Tips: gunakan tombol <span class="font-medium">Cetak</span> untuk mencetak sesuai filter.
        </div>
    </div>
</x-app-layout>
